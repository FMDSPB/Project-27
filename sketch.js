...
function setup() {
	...
	bob1 = new Bob(210, 500, PI*25);
	bob2 = new Bob(310, 500, PI*25);
	bob3 = new Bob(410, 500, PI*25);
	bob4 = new Bob(510, 500, PI*25);
	bob5 = new Bob(610, 500, PI*25);
...
function keyPressed() {
	if(keyDown(UP_ARROW)) {
		bob1.Matter.translate(bob1.body.position.x, 10);
	}
}